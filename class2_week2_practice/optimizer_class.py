"""
@Time : 2019/10/8 20:03 PM
@Author : bjjoy2009
优化梯度算法，momentum, Adam
"""
import numpy as np
...
def momentum(parameters, grads, v, alpha, beta):
    """
    momentum梯度下降
    :return: parameters, v
    """
    ...
    for l in range(L):
        ...
        parameters["b" + str(l+1)] = parameters['b' + str(l+1)] - alpha * v['db' + str(l+1)]
